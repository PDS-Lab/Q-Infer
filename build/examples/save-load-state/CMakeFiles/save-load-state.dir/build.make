...
examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.o: /home/wq/Q-infer/examples/save-load-state/save-load-state.cpp
examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.o: examples/save-load-state/CMakeFiles/save-load-state.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/wq/Q-infer/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.o"
	cd /home/wq/Q-infer/build/examples/save-load-state && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.o -MF CMakeFiles/save-load-state.dir/save-load-state.cpp.o.d -o CMakeFiles/save-load-state.dir/save-load-state.cpp.o -c /home/wq/Q-infer/examples/save-load-state/save-load-state.cpp
...
examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.i: cmake_force
	...
	cd /home/wq/Q-infer/build/examples/save-load-state && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/wq/Q-infer/examples/save-load-state/save-load-state.cpp > CMakeFiles/save-load-state.dir/save-load-state.cpp.i
...
examples/save-load-state/CMakeFiles/save-load-state.dir/save-load-state.cpp.s: cmake_force
	...
	cd /home/wq/Q-infer/build/examples/save-load-state && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/wq/Q-infer/examples/save-load-state/save-load-state.cpp -o CMakeFiles/save-load-state.dir/save-load-state.cpp.s
...
bin/save-load-state: /usr/local/cuda-12.2/targets/x86_64-linux/lib/libcudart.so
bin/save-load-state: /usr/local/cuda-12.2/targets/x86_64-linux/lib/libcublas.so
bin/save-load-state: /usr/local/cuda-12.2/targets/x86_64-linux/lib/libculibos.a
bin/save-load-state: /usr/local/cuda-12.2/targets/x86_64-linux/lib/libcublasLt.so
bin/save-load-state: examples/save-load-state/CMakeFiles/save-load-state.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/wq/Q-infer/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/save-load-state"
	cd /home/wq/Q-infer/build/examples/save-load-state && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/save-load-state.dir/link.txt --verbose=$(VERBOSE)
...
examples/save-load-state/CMakeFiles/save-load-state.dir/clean:
	cd /home/wq/Q-infer/build/examples/save-load-state && $(CMAKE_COMMAND) -P CMakeFiles/save-load-state.dir/cmake_clean.cmake
...
examples/save-load-state/CMakeFiles/save-load-state.dir/depend:
	cd /home/wq/Q-infer/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/wq/Q-infer /home/wq/Q-infer/examples/save-load-state /home/wq/Q-infer/build /home/wq/Q-infer/build/examples/save-load-state /home/wq/Q-infer/build/examples/save-load-state/CMakeFiles/save-load-state.dir/DependInfo.cmake --color=$(COLOR)

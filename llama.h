...
#include "ggml-cann.h"
#define LLAMA_MAX_DEVICES GGML_CANN_MAX_DEVICES
#else
...
#if defined(GGML_USE_CUBLAS) || defined(GGML_USE_CLBLAST) || defined(GGML_USE_METAL) || defined(GGML_USE_CANN)
...
extern "C" {
    ...
    LLAMA_API void llama_statistic(struct ggml_cgraph* cgraph);

    LLAMA_API void llama_show_stat();

    LLAMA_API void llama_stat_reset();

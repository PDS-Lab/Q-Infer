...
extern "C" {
    ...
    enum ggml_op {
        ...
        GGML_OP_SOFT_MAX_MAX,
        GGML_OP_SOFT_MAX_EXP,
        GGML_OP_SOFT_MAX_SUM,
        GGML_OP_SOFT_MAX_MERGE,
        GGML_OP_CPY_TENSOR,
    ...
    struct ggml_tensor {
        ...
        int layer;
        enum ggml_backend_type exec_place;
        char padding[4];
    };
    ...
    GGML_API struct ggml_tensor * ggml_soft_max_max(
            struct ggml_context * ctx,
            struct ggml_tensor  * a);

    GGML_API struct ggml_tensor * ggml_soft_max_exp(
            struct ggml_context * ctx,
            struct ggml_tensor  * a,
            struct ggml_tensor  * b);

    GGML_API struct ggml_tensor * ggml_soft_max_sum(
            struct ggml_context * ctx,
            struct ggml_tensor  * a);

    GGML_API struct ggml_tensor * ggml_soft_max_merge(
            struct ggml_context * ctx,
            struct ggml_tensor  * a,
            struct ggml_tensor  * b,
            struct ggml_tensor  * c,
    ...
    GGML_API struct ggml_tensor * ggml_timer_start(
            struct ggml_context * ctx,
            struct ggml_tensor  * a);

    GGML_API struct ggml_tensor * ggml_timer_stop(
            struct ggml_context * ctx,
            struct ggml_tensor  * a);

    GGML_API struct ggml_tensor * ggml_sync_point(
            struct ggml_context * ctx,
            struct ggml_tensor  * a);
